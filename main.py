...
from image_movement.load_images import load_images
...
from treshold_sets.pre_treshold import re2_bgd_treshold
from tqdm import tqdm


def main(thresholds=re2_bgd_treshold, enable_logging=False):
